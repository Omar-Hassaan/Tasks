...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=localhost;Initial Catalog=BikeStores;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Brand>(entity =>
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E2786A42F40");
        });

        modelBuilder.Entity<Category>(entity =>
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B4839ED8B7");
        });

        modelBuilder.Entity<Customer>(entity =>
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB858DABCC6D");
        });

        modelBuilder.Entity<Employee>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Employee__3214EC0791D867C5");

            entity.ToTable("Employees", "sales", tb => tb.HasTrigger("TRG_EmployeeLog"));
        });

        modelBuilder.Entity<EmployeeLog>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Employee__3214EC27E8465D4F");
        });

        modelBuilder.Entity<Log>(entity =>
        {
            entity.HasKey(e => e.LogId).HasName("PK__logs__9E2397E04EDF9FAF");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229BDF19243");

            entity.ToTable("orders", "sales", tb => tb.HasTrigger("trg_1"));
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D459C2BD71");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF51577EA51");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9CC7B8E4A4");
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D3FA1CC40A");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C8CD10C7F");
        });
